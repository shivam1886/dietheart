...
@section('title') {{__('Add Food')}} @endsection

@section('content')

<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">{{__('Add Food')}}</h3>
    </div>
</div>
<br/>
        <form class="form" action="{{route('store.food')}}" method="POST" enctype="multipart/form-data">
            @csrf
        <div class="row">
            <div class="col-md-6 col-offset-md-3">
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="form-group">
                                <input type="number" class="form-control" name="cholesterol" value="{{ old('cholesterol') }}" placeholder="{{__('Cholesterol')}}" required/>
                                @error('cholesterol')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
